              ...
              <div className={styles.file_body}>
                <div className={styles.file_bodyitem}>
                  ...
                  <div className={styles.file_bodyweak}>
                    Acne vulgaris is known to impair many aspects of quality of
                    life. However, the correlation of this impairment with
                    clinical severity remains equivocal despite various school,
                    community and hospital-based studies.
                  </div>
                </div>
                ...
                <div className={styles.file_bodyitem}>
                  ...
                  <div className={styles.file_bodyweak}>
                    ...
                    impairment of quality of life of patients of acne vulgaris
                    and correlate it with the severity of lesions.
                  </div>
                </div>
                ...
                <div className={styles.file_bodyitem}>
                  ...
                  <div className={styles.file_bodyweak}>
                    This was a cross-sectional, questionnaire-based study in a
                    cohort of 100 patients of acne vulgaris attending the
                    outpatient department of our referral hospital. A physician
                    measured the severity of lesions using the global acne
                    grading system, and patients assessed quality of life by
                    completing a questionnaire (Cardiff acne disability index).
                    A correlation of these two was done; some additional
                    correlations were brought out through demographic data
                ...
                <div className={styles.file_bodyitem}>
                  ...
                  <div className={styles.file_bodyweak}>
                    ...
                    consumed alcohol and/or smoked cigarettes were found to have
                    an impaired quality of life. While the severity of acne
                    progressively lessened in older patients, the impact on
                ...
                <div className={styles.file_bodyitem}>
                  ...
                  <div className={styles.file_bodyweak}>
                    The sample size was small and there was a lack of guaranteed
                    reliability on the self-reported quality of life.
                  </div>
                </div>
